package chapterEight.NewEmployeeProject;

public class EmployeeTest {
    public static void main(String[] args) {
        System.out.printf("Employee before instantiation: %d%n", Employee.getCount());

        Employee e1 = new Employee("Oludare", "David");
        Employee e2 = new Employee("Mikel", "Tyson");
//        Employee e3 = new Employee("Welcome", "Back");
